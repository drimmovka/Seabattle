...
void GUIRenderer::render(GameMapViewModel& game_map_view_model) {
...
void GUIRenderer::renderGameMap(GameMapViewModel& game_map_view_model, int type) {
...
void GUIRenderer::renderUnionGameMap(GameMapViewModel& game_map_view_model) {
...
void GUIRenderer::renderEnemyGameMap(GameMapViewModel& game_map_view_model) {
